...
TEST(IncomopressibleIsothermalLaminarFlow2D, residual)
{
    testEval<panzer::Traits::Residual, 2>(false);
}

TEST(IncomopressibleIsothermalLaminarFlowflow2D, jacobian)
{
...
TEST(IncomopressibleLaminarFlow2D, residual)
{
    testEval<panzer::Traits::Residual, 2>(true);
}

TEST(IncomopressibleLaminarFlow2D, jacobian)
{
...
TEST(IncomopressibleIsothermalLaminarFlow3D, residual)
{
    testEval<panzer::Traits::Residual, 3>(false);
}

TEST(IncomopressibleIsothermalLaminarFlow3D, jacobian)
{
